...
var
  ...
  LErrorMsg: String;
begin
  TOSLog.d('+TPlatformBiometric.HandleAuthenticationResult');
  ...
  begin
    ...
    begin
      ...
      FVerifyResult := TVerifyResult.Create(False, Format('Code: %d, Message: %s', [LErrorCode, LErrorMsg]), TBiometricFailResult.Error);
      if not FIsBackground then
        VerifyFailed;
    end
...
begin
  case TApplicationEventMessage(M).Value.Event of
    ...
    begin
      ...
      TOSLog.d('TApplicationEvent.EnteredBackground');
      // Cancel;
      FIsBackground := True;
    end;
